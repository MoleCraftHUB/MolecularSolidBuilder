...
class SLURMQueueRun:
    ...
    """ Class for communicating with the commonly used SLURM queing system
    ...
    def __init__(self, data_connection, tmp_folder, job_prefix,
                 ...
                 sbatch_command='sbatch', squeue_command='squeue',
    ...
    def relax(self, a):
        ...
        fd.close()
        os.system('{0} tmp_job_file.job'.format(self.sbatch_command))
        return fname
    ...
    def number_of_jobs_running(self):
        ...
        self.__cleanup__()
        p = Popen(['`which {0}` -u `whoami`'.format(self.squeue_command)],
